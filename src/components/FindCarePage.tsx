  ...
  return (
    <div className="min-h-screen pt-24 pb-16 bg-surface-soft">
      <div className="container mx-auto px-4">
        ...
        {/* Split Screen Layout */}
        {step < totalSteps ? (
          // Form in progress - split layout
          <div className="flex gap-6">
            {/* Left Side - AVA Paragraph */}
            <div className="w-1/2">
              <Card className="glass-card border-primary-bright/20">
                <CardContent className="p-6">
          ...
          // Form completed - full width layout with results
          <div className="space-y-8">
            <div className="flex gap-6">
              {/* Left Side - AVA Paragraph */}
              <div className="w-1/2">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-grow">
                        <h3 className="font-semibold text-text-primary mb-2">AVA Assistant</h3>
                        <p className="text-text-secondary">
                          Great! I've reviewed your information and found some excellent matches for you. Based on your preferences, 
                          here are the top facilities that meet your criteria.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                {assessmentMode === 'voice' && <AvaWidget />}
              </div>
        ...
        {/* Bottom Results - only shown while form is in progress and results container is empty */}
        {step < totalSteps && (!facilities || facilities.length === 0) && (
          <div className="mt-8">
            <ResultsContainer 
              facilities={facilities}
              summary={summary}
